...
int test() {
    ...
    assert(cAlphabeticSmallCapsConverter->convert(-5) == "-f");
//    assert(cAlphabeticSmallCapsConverter->convert(10) == "10");
//    assert(cAlphabeticSmallCapsConverter->convert(-10) == "-10");
//    assert(cAlphabeticSmallCapsConverter->convert(15) == "15");
//    assert(cAlphabeticSmallCapsConverter->convert(-15) == "-15");
//    assert(cAlphabeticSmallCapsConverter->convert(28) == "28");
//    assert(cAlphabeticSmallCapsConverter->convert(-28) == "-28");
//    assert(cAlphabeticSmallCapsConverter->convert(53) == "53");
//    assert(cAlphabeticSmallCapsConverter->convert(-53) == "-53");
//    assert(cAlphabeticSmallCapsConverter->convert(77) == "77");
//    assert(cAlphabeticSmallCapsConverter->convert(-77) == "-77");
//    assert(cAlphabeticSmallCapsConverter->convert(189) == "189");
//    assert(cAlphabeticSmallCapsConverter->convert(-189) == "-189");
//    assert(cAlphabeticSmallCapsConverter->convert(409) == "409");
//    assert(cAlphabeticSmallCapsConverter->convert(-409) == "-409");
//    assert(cAlphabeticSmallCapsConverter->convert(769) == "769");
//    assert(cAlphabeticSmallCapsConverter->convert(-769) == "-769");

    auto cAlphabeticBigCapsConverter = UnitConverter::create(UnitConverter::alphabeticalBigCaps);
    assert(cAlphabeticBigCapsConverter->convert(0) == "0");
    assert(cAlphabeticBigCapsConverter->convert(1) == "A");
    assert(cAlphabeticBigCapsConverter->convert(-1) == "-A");
    assert(cAlphabeticBigCapsConverter->convert(2) == "B");
    assert(cAlphabeticBigCapsConverter->convert(-2) == "-B");
    assert(cAlphabeticBigCapsConverter->convert(3) == "C");
    assert(cAlphabeticBigCapsConverter->convert(-3) == "-C");
    assert(cAlphabeticBigCapsConverter->convert(4) == "D");
    assert(cAlphabeticBigCapsConverter->convert(-4) == "-D");
    assert(cAlphabeticBigCapsConverter->convert(5) == "E");
    assert(cAlphabeticBigCapsConverter->convert(-5) == "-E");
//    assert(cAlphabeticBigCapsConverter->convert(10) == "10");
//    assert(cAlphabeticBigCapsConverter->convert(-10) == "-10");
//    assert(cAlphabeticBigCapsConverter->convert(15) == "15");
//    assert(cAlphabeticBigCapsConverter->convert(-15) == "-15");
//    assert(cAlphabeticBigCapsConverter->convert(28) == "28");
//    assert(cAlphabeticBigCapsConverter->convert(-28) == "-28");
//    assert(cAlphabeticBigCapsConverter->convert(53) == "53");
//    assert(cAlphabeticBigCapsConverter->convert(-53) == "-53");
//    assert(cAlphabeticBigCapsConverter->convert(77) == "77");
//    assert(cAlphabeticBigCapsConverter->convert(-77) == "-77");
//    assert(cAlphabeticBigCapsConverter->convert(189) == "189");
//    assert(cAlphabeticBigCapsConverter->convert(-189) == "-189");
//    assert(cAlphabeticBigCapsConverter->convert(409) == "409");
//    assert(cAlphabeticBigCapsConverter->convert(-409) == "-409");
//    assert(cAlphabeticBigCapsConverter->convert(769) == "769");
//    assert(cAlphabeticBigCapsConverter->convert(-769) == "-769");
